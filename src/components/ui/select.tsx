...
// A styled native <select>. Chosen over Radix Select for filter bars because
// it works perfectly inside forms, URLs and server components without extra JS,
// and is fully accessible/native on mobile.
