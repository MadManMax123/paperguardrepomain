...
export function BulkUploadForm({ filterOptions, schools }: { filterOptions: FilterOptions; schools: School[] }) {
  ...
  async function submitAll() {
    ...
    if (doneCount) toast.success(`${doneCount} paper${doneCount === 1 ? "" : "s"} published.`);
